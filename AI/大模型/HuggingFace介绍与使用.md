...
![image.png](https://s2.loli.net/2023/11/22/vKlpb1kLUGjHOt6.png)

![image.png](https://s2.loli.net/2023/11/22/XmF3qy4sihNfUOC.png)

我们点击Helsinki-NLP/opus-mt-en-zh进入这个模型的卡片页，就能看到更详细的介绍。并且很多模型，都在右侧提供了对应的示例。不使用代码，你也可以直接体验一下模型的能力和效果。

![image.png](https://s2.loli.net/2023/11/22/XZ16pKyWVtgTYeP.png)
...
![image.png](https://s2.loli.net/2023/11/22/DQjaStcBkgmAIyx.png)
...
![image.png](https://s2.loli.net/2023/11/22/5LZGWm1it2aRV6l.png)
...
![image.png](https://s2.loli.net/2023/11/22/W3pf8zkDaLXSTeZ.png)

设置好了之后，你再点击最下面的 **Create Endpoint**，HuggingFace就会开始帮你创建机器资源，部署对应的模型了。

![image.png](https://s2.loli.net/2023/11/22/WD3hn1OHBu7GT9P.png)
...
![image.png](https://s2.loli.net/2023/11/22/6cEQGW9Bavd7weI.png)
...
![image.png](https://s2.loli.net/2023/11/22/KLfPJtvWh8XpMlc.png)

如果你彻底不需要使用这个模型了，你可以把对应的Endpoint删掉，你只需要在对应Endpoint的Setting页面里输入Endpoint的名称，然后选择删除就好了。

![image.png](https://s2.loli.net/2023/11/22/dgzo3eTxXcKaLHU.png)
