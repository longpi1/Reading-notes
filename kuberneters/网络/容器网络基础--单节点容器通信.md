...
所谓“网络栈”，包括了：**网卡（Network Interface）、回环设备（Loopback Device）、路由表（Routing Table）和iptables规则**。对于一个进程来说，这些要素，构成了它发起和响应网络请求的基本环境。
...
就会发现一个新的、名叫vethb4963f3的虚拟网卡，也被“插”在了docker0网桥上。
