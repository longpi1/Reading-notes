...
> 主要内容转载自 [TiDB 源码阅读系列文章（七）基于规则的优化](https://cn.pingcap.com/blog/tidb-source-code-reading-7/)
...
![未经优化表示图](https://img1.pingcap.com/prod/1_5d26a18dc3.png)
...
这篇文章是基于规则优化（RBO）的上篇。介绍了逻辑查询计划里面基本的算子，以及一部分的优化规则。后续还将介绍更多的优化规则，以及基于代价的优化（CBO）。